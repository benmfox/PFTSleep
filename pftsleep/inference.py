...
# %% auto #0
__all__ = ['ENCODER_DEFAULTS', 'CLASSIFIER_HEAD_DEFAULTS', 'FREQUENCY_DEFAULT', 'HYPNOGRAM_FREQUENCY_DEFAULT',
           'HYPNOGRAM_EPOCH_SECONDS_DEFAULT', 'SEQUENCE_LENGTH_SECONDS_DEFAULT', 'HYPNOGRAM_PADDING_DEFAULT',
           'FREQUENCY_FILTERS_ORDERED_DEFAULT', 'MEDIAN_FILTER_KERNEL_SIZE_DEFAULT', 'load_pftsleep_models',
           'download_pftsleep_models', 'process_edf', 'view_edf_channels', 'EDFDataset', 'map_stage', 'create_hypjson',
           'write_pred_to_hypjson', 'infer_on_edf', 'infer_on_edf_dataset']

# %% ../nbs/12_inference.ipynb #12833478
...
# %% ../nbs/12_inference.ipynb #6cdcc3a8
...
# %% ../nbs/12_inference.ipynb #e2b8ff03
...
# %% ../nbs/12_inference.ipynb #c144b9ee
...
# %% ../nbs/12_inference.ipynb #ff630e5f
...
# %% ../nbs/12_inference.ipynb #70fba004
...
# %% ../nbs/12_inference.ipynb #960bbbce
def map_stage(stage):
    if stage == 4:
        return 5  # REM
...
# %% ../nbs/12_inference.ipynb #a24c718b
...
# %% ../nbs/12_inference.ipynb #2a75ff87
